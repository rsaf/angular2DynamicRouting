 ...
 * with this class will be done through the Shop Facade
 *
...
use Gineign\Shop\Events\CartCheckout;
use Gineign\Shop\Events\OrderCompleted;
use Gineign\Shop\Events\OrderPlaced;
use Gineign\Shop\Events\OrderStatusChanged;
...
class Shop
{
    ...
    public static function checkout($cart = null)
    {
        ...
        try {
            ...
            if (empty($cart)) $cart = Sentinel::getUser()->cart;
