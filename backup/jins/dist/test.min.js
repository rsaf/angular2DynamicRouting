...
(function (play) {
    var Wish = (function (_super) {
        ...
        Wish.prototype.setIntroWith = function () {
...
(function (intro) {
    var AlreadyPlayed = (function (_super) {
        ...
        function AlreadyPlayed() {
            ...
            while (++j < App.userBalloons.length) {
                ...
                if (j == 2)
                    break; // 3 balloon + 1 added bellow.
            }
    ...
    intro.AlreadyPlayed = AlreadyPlayed;
})(intro || (intro = {}));
/// <reference path="../../App.ts" />
/// <reference path="Intro.ts" />
var intro;
...
(function (intro) {
    var Intro = (function (_super) {
        ...
        Intro.prototype.fnHideAlreadyPlayed = function () {
        ...
        Intro.prototype.fnHideIntro = function () {
