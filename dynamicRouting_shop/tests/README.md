...
"autoload": {
    "classmap": [
        "database",
        "Gineign/laravel-shop/src/commands"
    ],
    "psr-4": {
        "App\\": "app/",
        "Gineign\\Shop\\": "Gineign/laravel-shop/src"
    }
},
```
...
```php
'gateways' => [
    'testFail'          =>  Gineign\Shop\Gateways\GatewayFail::class,
    'testPass'          =>  Gineign\Shop\Gateways\GatewayPass::class,
    'testCallback'      =>  Gineign\Shop\Gateways\GatewayCallback::class,
],
```
